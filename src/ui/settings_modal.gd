...
func _build_ui() -> void:
	...
	res_options.add_item("Pełny ekran (Fullscreen - F11)", 0)
	res_options.add_item("Maksymalne okno (Maximized)", 1)
	res_options.add_item("1920x1080 (Okno)", 2)
	res_options.add_item("1280x720 (Okno)", 3)
